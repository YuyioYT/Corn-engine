...
class HealthBar extends FlxSpriteGroup
{
	...
	public function new(x:Float, y:Float, image:String = 'bars/healthBar', valueFunction:Void->Float = null, boundX:Float = 0, boundY:Float = 1)
	{
		super(x, y);

		if (ClientPrefs.data.healthBarType == 'Square') {
			image = 'bars/healthBar';
		} else if (ClientPrefs.data.healthBarType == 'Circle') {
			image = 'bars/healthBarCircle';
		} else {
			image = 'bars/healthBarYuyio';
		}

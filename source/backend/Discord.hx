...
class DiscordClient
{
	...
	private static var _defaultID:String = "1129945292603666523";
	...
	public static function changePresence(details:String ='No leaks', state:Null<String> = 'No leaks', ?smallImageKey : String = 'icon', ?hasStartTimestamp : Bool, ?endTimestamp: Float)
	{
		...
		_options.largeImageText = "Engine Version: " + states.MainMenuState.cornEngineVersion;

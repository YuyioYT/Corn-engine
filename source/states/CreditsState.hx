...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var defaultList:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			['Corn engine developer'],
			['Yuyio',    'yuyio',            'Source, artist',                                                         'https://www.youtube.com/@yuyioyt6066',                             '00FF8B'],
			['EC Developer'],
			['MinecraftBoy2038',    'mcboy',            'Source and Lua Coder',                                                         'https://www.youtube.com/c/MinecraftBoy2038',                             'a81022'],
			[''],
			['Void Chronicles Shaders'],
			[''],
			...
			['Fearester',			'fearester',		'Third Programmer of SB Engine',			'https://www.youtube.com/@fearester1282',				'5E99DF'],
			[''],
			['Special credits'],
			['Lizzy Strawbery',		'lizzy',			'Fixed lua shaders from Psych Engine 0.5.1',			'https://www.youtube.com/@LizzyStrawberry',				'ff03d9'],
			['Notweuz',				'weuz',				'Creator of OS Engine',				'https://www.youtube.com/channel/UC2XJzq2EaMQUw61IC_sComw',		'8633F2'],
			[''],
			['Psych Engine Team'],

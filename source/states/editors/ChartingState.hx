...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['Smooth Camera Zoom', "!! NOT TO BE CONFUSED WITH THE 'ADD CAMERA ZOOM' EVENT !!\nSets the Default Game Camera Zoom\nenter your value in Value 1."],
	...
	**/
	...
	override function create()
	{
		...
		bg.scrollFactor.set(); // Aquí deberías definir los factores de desplazamiento apropiadamente
		bg.color = 0xFFFF7300; // Color por defecto si healthColorArray no está definido o es demasiado corto
		
		add(bg);
		

		gradientBar = FlxGradient.createGradientFlxSprite(Math.round(FlxG.width), 512, [0xb2ff0000, 0x71FF5100, 0x00000000], 1, 90, true);
		gradientBar.y = 0;
		add(gradientBar);
	...
	function addSongUI():Void
	{
		...
		var check_Trails = new FlxUICheckBox(10,280, null, null, "Opponent Trail", 100);
		...
		var healthdrainOBJ:FlxUINumericStepper = new FlxUINumericStepper(player1DropDown.x + 140, gfVersionDropDown.y + 20, 1, 0, 0, 99, 0);
	...
	function addNoteUI():Void
	{
		...
		var check_cameraMove = new FlxUICheckBox(80, 25, null, null, "Move Camera on Note Hits", 100);
		...
		var check_swapNote = new FlxUICheckBox(200,25, null, null, "Swap Strumline Position", 100);
		...
		tab_group_note.add(check_swapNote);
		tab_group_note.add(check_cameraMove);
	...
	function addEventsUI():Void
	{
		...
		var check_CanFly = new FlxUICheckBox( 80, 30, null, null, "Can Fly", 100);
		check_CanFly.checked = _song.canFly;
		check_CanFly.callback = function()
		{
			_song.canFly = check_CanFly.checked;
		};
		...
		tab_group_event.add(check_CanFly);
	...
	function addDataUI()
	{
		...
		//
		var check_disableDebug = new FlxUICheckBox(10,200, null, null, "Disable Debugmenu Buttons", 100);
		...
		var check_antiMash = new FlxUICheckBox(10, 230, null, null, "Disable Antimash", 100);
